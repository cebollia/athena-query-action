...
var serializeAws_json1_1CreateDataCatalogInput = function (input, context) {
    return __assign(__assign(__assign(__assign(__assign({}, (input.Description !== undefined && input.Description !== null && { Description: input.Description })), (input.Name !== undefined && input.Name !== null && { Name: input.Name })), (input.Parameters !== undefined &&
        input.Parameters !== null && { Parameters: serializeAws_json1_1ParametersMap(input.Parameters, context) })), (input.Tags !== undefined && input.Tags !== null && { Tags: serializeAws_json1_1TagList(input.Tags, context) })), (input.Type !== undefined && input.Type !== null && { Type: input.Type }));
};
var serializeAws_json1_1CreateNamedQueryInput = function (input, context) {
    var _a;
    return __assign(__assign(__assign(__assign(__assign({ ClientRequestToken: (_a = input.ClientRequestToken) !== null && _a !== void 0 ? _a : generateIdempotencyToken() }, (input.Database !== undefined && input.Database !== null && { Database: input.Database })), (input.Description !== undefined && input.Description !== null && { Description: input.Description })), (input.Name !== undefined && input.Name !== null && { Name: input.Name })), (input.QueryString !== undefined && input.QueryString !== null && { QueryString: input.QueryString })), (input.WorkGroup !== undefined && input.WorkGroup !== null && { WorkGroup: input.WorkGroup }));
};
...
var serializeAws_json1_1CreateWorkGroupInput = function (input, context) {
    ...
    })), (input.Description !== undefined && input.Description !== null && { Description: input.Description })), (input.Name !== undefined && input.Name !== null && { Name: input.Name })), (input.Tags !== undefined && input.Tags !== null && { Tags: serializeAws_json1_1TagList(input.Tags, context) }));
};
...
var serializeAws_json1_1DeletePreparedStatementInput = function (input, context) {
    return __assign(__assign({}, (input.StatementName !== undefined && input.StatementName !== null && { StatementName: input.StatementName })), (input.WorkGroup !== undefined && input.WorkGroup !== null && { WorkGroup: input.WorkGroup }));
};
var serializeAws_json1_1DeleteWorkGroupInput = function (input, context) {
    return __assign(__assign({}, (input.RecursiveDeleteOption !== undefined &&
        input.RecursiveDeleteOption !== null && { RecursiveDeleteOption: input.RecursiveDeleteOption })), (input.WorkGroup !== undefined && input.WorkGroup !== null && { WorkGroup: input.WorkGroup }));
};
var serializeAws_json1_1EncryptionConfiguration = function (input, context) {
    return __assign(__assign({}, (input.EncryptionOption !== undefined &&
        input.EncryptionOption !== null && { EncryptionOption: input.EncryptionOption })), (input.KmsKey !== undefined && input.KmsKey !== null && { KmsKey: input.KmsKey }));
};
var serializeAws_json1_1EngineVersion = function (input, context) {
    return __assign(__assign({}, (input.EffectiveEngineVersion !== undefined &&
...
var serializeAws_json1_1GetNamedQueryInput = function (input, context) {
    return __assign({}, (input.NamedQueryId !== undefined && input.NamedQueryId !== null && { NamedQueryId: input.NamedQueryId }));
};
...
var serializeAws_json1_1GetQueryExecutionInput = function (input, context) {
    return __assign({}, (input.QueryExecutionId !== undefined &&
...
var serializeAws_json1_1GetQueryResultsInput = function (input, context) {
    return __assign(__assign(__assign({}, (input.MaxResults !== undefined && input.MaxResults !== null && { MaxResults: input.MaxResults })), (input.NextToken !== undefined && input.NextToken !== null && { NextToken: input.NextToken })), (input.QueryExecutionId !== undefined &&
        input.QueryExecutionId !== null && { QueryExecutionId: input.QueryExecutionId }));
};
var serializeAws_json1_1GetTableMetadataInput = function (input, context) {
    return __assign(__assign(__assign({}, (input.CatalogName !== undefined && input.CatalogName !== null && { CatalogName: input.CatalogName })), (input.DatabaseName !== undefined && input.DatabaseName !== null && { DatabaseName: input.DatabaseName })), (input.TableName !== undefined && input.TableName !== null && { TableName: input.TableName }));
};
...
var serializeAws_json1_1ListDatabasesInput = function (input, context) {
    return __assign(__assign(__assign({}, (input.CatalogName !== undefined && input.CatalogName !== null && { CatalogName: input.CatalogName })), (input.MaxResults !== undefined && input.MaxResults !== null && { MaxResults: input.MaxResults })), (input.NextToken !== undefined && input.NextToken !== null && { NextToken: input.NextToken }));
};
...
var serializeAws_json1_1ListNamedQueriesInput = function (input, context) {
    return __assign(__assign(__assign({}, (input.MaxResults !== undefined && input.MaxResults !== null && { MaxResults: input.MaxResults })), (input.NextToken !== undefined && input.NextToken !== null && { NextToken: input.NextToken })), (input.WorkGroup !== undefined && input.WorkGroup !== null && { WorkGroup: input.WorkGroup }));
};
...
var serializeAws_json1_1ListTableMetadataInput = function (input, context) {
    return __assign(__assign(__assign(__assign(__assign({}, (input.CatalogName !== undefined && input.CatalogName !== null && { CatalogName: input.CatalogName })), (input.DatabaseName !== undefined && input.DatabaseName !== null && { DatabaseName: input.DatabaseName })), (input.Expression !== undefined && input.Expression !== null && { Expression: input.Expression })), (input.MaxResults !== undefined && input.MaxResults !== null && { MaxResults: input.MaxResults })), (input.NextToken !== undefined && input.NextToken !== null && { NextToken: input.NextToken }));
};
...
var serializeAws_json1_1UpdateWorkGroupInput = function (input, context) {
    return __assign(__assign(__assign(__assign({}, (input.ConfigurationUpdates !== undefined &&
    ...
    })), (input.Description !== undefined && input.Description !== null && { Description: input.Description })), (input.State !== undefined && input.State !== null && { State: input.State })), (input.WorkGroup !== undefined && input.WorkGroup !== null && { WorkGroup: input.WorkGroup }));
};
var serializeAws_json1_1WorkGroupConfiguration = function (input, context) {
    return __assign(__assign(__assign(__assign(__assign(__assign({}, (input.BytesScannedCutoffPerQuery !== undefined &&
        input.BytesScannedCutoffPerQuery !== null && { BytesScannedCutoffPerQuery: input.BytesScannedCutoffPerQuery })), (input.EnforceWorkGroupConfiguration !== undefined &&
        ...
        input.RequesterPaysEnabled !== null && { RequesterPaysEnabled: input.RequesterPaysEnabled })), (input.ResultConfiguration !== undefined &&
        input.ResultConfiguration !== null && {
        ResultConfiguration: serializeAws_json1_1ResultConfiguration(input.ResultConfiguration, context),
    }));
};
var serializeAws_json1_1WorkGroupConfigurationUpdates = function (input, context) {
    return __assign(__assign(__assign(__assign(__assign(__assign(__assign({}, (input.BytesScannedCutoffPerQuery !== undefined &&
        input.BytesScannedCutoffPerQuery !== null && { BytesScannedCutoffPerQuery: input.BytesScannedCutoffPerQuery })), (input.EnforceWorkGroupConfiguration !== undefined &&
        input.EnforceWorkGroupConfiguration !== null && {
        EnforceWorkGroupConfiguration: input.EnforceWorkGroupConfiguration,
    })), (input.EngineVersion !== undefined &&
        ...
        input.RequesterPaysEnabled !== null && { RequesterPaysEnabled: input.RequesterPaysEnabled })), (input.ResultConfigurationUpdates !== undefined &&
...
var deserializeAws_json1_1BatchGetNamedQueryOutput = function (output, context) {
    return {
        NamedQueries: output.NamedQueries !== undefined && output.NamedQueries !== null
            ...
            : undefined,
        UnprocessedNamedQueryIds: output.UnprocessedNamedQueryIds !== undefined && output.UnprocessedNamedQueryIds !== null
...
var deserializeAws_json1_1BatchGetQueryExecutionOutput = function (output, context) {
    return {
        QueryExecutions: output.QueryExecutions !== undefined && output.QueryExecutions !== null
            ...
            : undefined,
        UnprocessedQueryExecutionIds: output.UnprocessedQueryExecutionIds !== undefined && output.UnprocessedQueryExecutionIds !== null
...
var deserializeAws_json1_1GetDataCatalogOutput = function (output, context) {
    return {
        DataCatalog: output.DataCatalog !== undefined && output.DataCatalog !== null
...
var deserializeAws_json1_1GetNamedQueryOutput = function (output, context) {
    return {
        NamedQuery: output.NamedQuery !== undefined && output.NamedQuery !== null
...
var deserializeAws_json1_1GetPreparedStatementOutput = function (output, context) {
    return {
        PreparedStatement: output.PreparedStatement !== undefined && output.PreparedStatement !== null
...
var deserializeAws_json1_1GetQueryExecutionOutput = function (output, context) {
    return {
        QueryExecution: output.QueryExecution !== undefined && output.QueryExecution !== null
...
var deserializeAws_json1_1GetTableMetadataOutput = function (output, context) {
    return {
        TableMetadata: output.TableMetadata !== undefined && output.TableMetadata !== null
